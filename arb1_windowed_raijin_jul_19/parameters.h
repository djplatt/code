...
/*
//main(21/512/8,2^20,32,1e11,23,8,70,13/64,141000,116) 
#define T0_MAX ((double) 10.000000000000000000000000000000000000e10)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
...
/*
//main(21/512/8,2^20,32,2e11,23,8,70,13/64,198000,116)
...
*/
/*
//main(21/512/8,2^20,32,3e11,23,8,70,13/64,250000,116)
...
/*
//main(21/512/8,2^20,32,6e11,23,8,70,13/64,343000,116)
...
*/
/*
//main(21/512/8,2^20,32,7e11,23,8,70,13/64,371000,116)
...
/*
//main(21/512/8,2^20,32,8e11,23,8,70,13/64,396000,116)
...
//main(21/512/8,2^20,32,9e11,23,8,70,13/64,420000,116)
...
/*
//main(21/512/8,2^20,32,1.2e12,23,8,70,13/64,485000,116)
...
//main(21/512/8,2^20,32,1.4e12,23,8,70,13/64,524000,116)
...
//main(21/512/8,2^20,32,1.6e12,23,8,70,13/64,560000,116) 
...
//main(21/512/8,2^20,32,1.8e12,23,8,70,13/64,595000,116)
#define T0_MAX ((double) 1.8000000000000000000000000000000000000e12)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
#define one_over_A ((double) 5.1269531250000000000000000000000000000e-3)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 2.14e-115)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 595000)
#define fhatsumerr_d ((double) 2.36e-34)
#define K ((int) 23)
#define tayerr_d ((double) 5.93e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 4.50e-256)
#define INTER_SPACING ((int) 8)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 1.48e-40)
//************************************


//main(21/512/8,2^20,32,1.9e12,23,8,70,13/64,615000,116)
#define T0_MAX ((double) 1.9000000000000000000000000000000000000e12)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
#define one_over_A ((double) 5.1269531250000000000000000000000000000e-3)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 2.17e-115)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 615000)
#define fhatsumerr_d ((double) 3.28e-38)
#define K ((int) 23)
#define tayerr_d ((double) 6.02e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 6.35e-255)
#define INTER_SPACING ((int) 8)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 1.56e-40)
//************************************


//main(21/512/8,2^20,32,2e12,23,8,70,13/64,626000,116) 
#define T0_MAX ((double) 2.0000000000000000000000000000000000000e12)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
#define one_over_A ((double) 5.1269531250000000000000000000000000000e-3)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 2.19e-115)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 626000)
#define fhatsumerr_d ((double) 3.46e-33)
#define K ((int) 23)
#define tayerr_d ((double) 6.08e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 7.84e-254)
#define INTER_SPACING ((int) 8)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 1.64e-40)
//************************************


//main(21/512/8,2^20,32,2.2e12,23,8,70,13/64,657000,116)
#define T0_MAX ((double) 2.2000000000000000000000000000000000000e12)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
#define one_over_A ((double) 5.1269531250000000000000000000000000000e-3)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 2.23e-115)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 657000)
#define fhatsumerr_d ((double) 1.33e-33)
#define K ((int) 23)
#define tayerr_d ((double) 6.23e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 8.37e-252)
#define INTER_SPACING ((int) 8)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 1.80e-40)


//main(21/512/8,2^20,32,2.4e12,23,8,70,13/64,686000,116)
#define T0_MAX ((double) 2.4000000000000000000000000000000000000e12)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
#define one_over_A ((double) 5.1269531250000000000000000000000000000e-3)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 2.27e-115)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 686000)
#define fhatsumerr_d ((double) 2.07e-33)
#define K ((int) 23)
#define tayerr_d ((double) 6.36e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 5.95e-250)
#define INTER_SPACING ((int) 8)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 1.96e-40)
//************************************
*/

//main(21/512/8,2^20,32,2.6e12,23,8,70,13/64,714000,116) 
#define T0_MAX ((double) 2.6000000000000000000000000000000000000e12)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 32)
#define N ((int) 1048576)
#define one_over_A ((double) 5.1269531250000000000000000000000000000e-3)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 2.31e-115)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 714000)
#define fhatsumerr_d ((double) 2.12e-33)
#define K ((int) 23)
#define tayerr_d ((double) 6.49e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 3.01e-248)
#define INTER_SPACING ((int) 8)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 2.12e-40)
//************************************
