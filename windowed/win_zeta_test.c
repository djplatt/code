...
#define Ns (75) // take this many points either side of t0
#define H ((double) 2149.0/16384.0) // Gaussian width for upsampling
#define INTER_SPACING (5) // Use every 5th sample
#define intererr_d ((double) 4.2e-45)
...
void print_usage()
{
  printf("Usage:- win_zeta1.8 prec t_min num_its step outfile stat_pts?.\n");
