...
// upsammoreD4096.cpp
//
// use more detailed upsampling to find zeros missed by upsammoreC etc
// saves data suitable for processing by upsamdouble.cpp and upsamhigh.c
// only check index given as third command line argument
//
// version 1.0
...
int main(int argc, char **argv)
{
  ...
  while(fread(&q,sizeof(int),1,infile))
	...
	{
	  printf("Skipping index %d (target=%d)\n",index,target_index);
	  continue;
	}
      */
