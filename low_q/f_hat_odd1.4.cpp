...
/* called when wrong arguments passed via command line */
{
  ...
  printf("  (ofname)    - input to f_odd.cpp (via spec file)\n");
  exit(1);
}
...
int main(int argc, char **argv)
{
  ...
  //printf("Starting...\n");
  make_l_odd(q,num_s,factors,q_n,offset_vec,a_n,omegas,B,n0,eta_even,infile);
  ...
  printf("%s successful completion on q=%d n=[%d,%d)\n",argv[0],q,n0,n1);
  return(0);
}
