...
void print_usage()
{
  printf("Usage:- f (# in files) (in file stub) (out file stub) (even_p) \n");
...
int main(int argc, char **argv)
{
  ...
  printf("Running f1.2 with %d files\n",NUM_FILES);
  ...
  fread(&N,sizeof(unsigned int),1,infiles[0]);
  printf("N=%d\n",N);
  ...
  printf("f1.2 Successful completion.\n");
