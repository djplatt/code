...
tcsqrt: tcsqrt.o $(INCS) $(LIBS)
	$(CC) -o tcsqrt tcsqrt.o $(LIBS)

tcsin: tcsin.o $(INCS) $(LIBS)
	$(CC) -o tcsin tcsin.o $(LIBS)

tcpow: tcpow.o $(INCS) $(LIBS)
	$(CC) -o tcpow tcpow.o $(LIBS)

tclog: tclog.o $(INCS) $(LIBS)
	$(CC) -o tclog tclog.o $(LIBS)

tcexp: tcexp.o $(INCS) $(LIBS)
	$(CC) -o tcexp tcexp.o $(LIBS)

tcabs: tcabs.o $(INCS) $(LIBS)
	$(CC) -o tcabs tcabs.o $(LIBS)

tcsqrtf: tcsqrtf.o $(INCS) $(LIBS)
	$(CC) -o tcsqrtf tcsqrtf.o $(LIBS)

tcsinf: tcsinf.o $(INCS) $(LIBS)
	$(CC) -o tcsinf tcsinf.o $(LIBS)

tcpowf: tcpowf.o $(INCS) $(LIBS)
	$(CC) -o tcpowf tcpowf.o $(LIBS)

tclogf: tclogf.o $(INCS) $(LIBS)
	$(CC) -o tclogf tclogf.o $(LIBS)

tcexpf: tcexpf.o $(INCS) $(LIBS)
	$(CC) -o tcexpf tcexpf.o $(LIBS)

tcabsf: tcabsf.o $(INCS) $(LIBS)
