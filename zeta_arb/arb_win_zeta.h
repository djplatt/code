...
inline sign_t arb_sign(arb_t x)
{
...
inline dir_t arb_dir(arb_ptr left, arb_ptr right)
{
...
inline sign_t acb_sign(acb_t x)
{
...
inline dir_t acb_dir(acb_ptr left, acb_ptr right)
{
