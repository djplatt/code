...
// parameter set for calculating residues
//main(21/512,2^17,4,1.01e10,23,1,70,13/64,44500,116)
#define T0_MAX ((double) 1.0100000000000000000000000000000000000e10)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e8)
#define UPSAM ((int) 4)
#define N ((int) 131072)
#define one_over_A ((double) 4.1015625000000000000000000000000000000e-2)
#define h ((double) 1.1600000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 7.50e-116)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 44500)
#define fhatsumerr_d ((double) 2.21e-33)
#define K ((int) 23)
#define tayerr_d ((double) 1.62e-33)
#define gtwiderr_d ((double) 1.83e-44)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 1e-307)
#define INTER_SPACING ((int) 1)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 3.39e-42)
//************************************
