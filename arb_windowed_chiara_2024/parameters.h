...
//main(17/512,2^17,4,1e20,23,1,70,13/64,4500000000,100)
#define T0_MAX ((double) 1.0000000000000000000000000000000000000e20)
#define T0_MIN ((double) 1.0000000000000000000000000000000000000e10)
#define UPSAM ((int) 4)
#define N ((int) 131072)
#define one_over_A ((double) 3.3203125000000000000000000000000000000e-2)
#define h ((double) 1.0000000000000000000000000000000000000e2)
#define ftwiderr_d ((double) 4.54e-100)
#define fhattwiderr_d ((double) 1e-307)
#define M ((int) 4500000000)
#define fhatsumerr_d ((double) 4.26e-33)
#define K ((int) 23)
#define tayerr_d ((double) 1.90e-30)
#define gtwiderr_d ((double) 1.06e-32)
#define Gtwiderr_d ((double) 1e-307)
#define Fmaxerr_d ((double) 2.48e-69)
#define INTER_SPACING ((int) 1)
#define H ((double) 2.0312500000000000000000000000000000000e-1)
#define Ns ((int) 70)
#define intererr_d ((double) 5.73e-27)
//************************************
*/
