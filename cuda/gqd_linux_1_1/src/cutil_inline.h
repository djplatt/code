...
int64_t __bar__;
#define CUT_SAFE_CALL(x) {__bar__ = (int64_t) x;}
#define CUDA_SAFE_CALL(x) x
#define cutCreateTimer(x) x
#define cutStartTimer(x) x
#define cutStopTimer(x) x
#define cutGetTimerValue(x) x
#define cutDeleteTimer(x) x
